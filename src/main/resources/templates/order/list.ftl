<html>
    ...
    <body>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button onclick="location.reload()" type="button" class="btn btn-primary">查看新的订单（当前页面刷新）</button>
                    </div>
                </div>
        ...
        <audio id="notice" loop="loop">
            <source src="/sell/mp3/iamaudio.mp3" type="audio/mpeg"/>
        </audio>
    ...
    <script>
        ...
        if('WebSocket' in window){
            websocket = new WebSocket('ws://mishi.fantreal.com/sell/webSocket');
        }else{
            alert('该浏览器不支持！');
        }
